    ...
    return (function () {
      ...
      function render(self) {
        ...
        var renderLeaf = function (item) {
          ...
          if (item.root) { icon = '<i class="fas fa-fw fa-book"></i>'; }
          else { icon = '<i class="fas fa-fw fa-folder"></i>'; }
          expando.innerHTML = arrow + icon;
          ...
          if (item.children) {
            ...
            expando.innerHTML = '<i class="far fa-fw fa-file"></i>';
      ...
      TreeView.prototype.reload = function (data, node) {
        this.node = node;
        this.data = data;
        render(this);
      }
